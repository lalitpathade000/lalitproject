...
public class SlidingAdapter extends PagerAdapter {
    ...
    public SlidingAdapter(Context context, ArrayList<String> IMAGES) {
        ...
        Log.e("aaaget", "SlidingAdapter contructor called");
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        if (imageLayout == null) {
            Log.e("aaa", "imageLayout null");
        } else {
            Log.e("aaa", "imageLayout not null");
    ...
    /*
            ...
            Picasso.with(context).load("http://www.cityxpress.in" + IMAGES.get(position))
                    ...
                    .placeholder(R.drawable.ic_logo).error(R.drawable.ic_logo).fit()
                    .centerCrop()
