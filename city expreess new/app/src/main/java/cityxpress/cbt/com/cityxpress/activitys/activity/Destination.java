...
public class Destination extends AppCompatActivity {
    ...
    private void init() {
        recyclerView = findViewById(R.id.destination_rv);
        searchview = findViewById(R.id.destination_searchview);
    ...
    private void initvalue() {
        ...
        adapter = new DestinationAdapter(context, MyApplication.allStation);
